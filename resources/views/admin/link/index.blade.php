...
<body>
	...
	<div id="wrapper">
		...
		<!-- 后台 首页 主体 开始 -->
		<div class="main">
			<h1 style="vertical-align: inherit;margin:15px;">链接列表</h1>
			...
			<!-- 搜索框开始 -->
				<div class="form-body" data-example-id="simple-form-inline">
					<form class="form-inline" action="/admin/link" method="get"> 
						<div class="form-group"> 
							<label for="title">标题&nbsp;</label> 
							<input type="text" class="form-control" name="search_title" value="{{ $params['search_title'] or '' }}" id="title" placeholder="链接标题">&nbsp;&nbsp;&nbsp;&nbsp;
							<label for="url">地址&nbsp;</label> 
							<input type="text" class="form-control" name="search_url" value="{{ $params['search_url'] or '' }}" id="url" placeholder="链接地址"> &nbsp;&nbsp;&nbsp;&nbsp;
						</div> 
			...
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">显示友情链接详情</h3>
				</div>
				<table class="table table-bordered">
					...
					<tr align="center">
						...
						<td style="line-height:58px;">{{ $v->title }}</td>
						<td style="line-height:58px;">{{ $v->url }}</td>
				...
				<script>
					...
					{
						$.get('/admin/link/wakeUp',{id:id,status:status},function(res){
							if(res=='ok'){
