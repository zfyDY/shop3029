...
<body>
	...
	<div id="wrapper">
		...
		<!-- 后台 首页 主体 开始 -->
		<div class="main">
			<h1 style="vertical-align: inherit;margin:15px;">添加广告位</h1>
			...
			<form action="/admin/adve" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="panel">
					<div class="panel-body">
						<div>
							<h4><font style="vertical-align: inherit;">广告位标题</font></h4>
							<input type="text" name="title" class="form-control" placeholder="请输入链接标题" value="{{ old('title') }}">
						</div>
						<div>
							<h4><font style="vertical-align: inherit;">广告位地址</font></h4>
							<input type="text" name="url" class="form-control" placeholder="请输入链接地址" value="{{ old('url') }}">
						</div>
						<div>
							<h4><font style="vertical-align: inherit;">广告图</font></h4>
