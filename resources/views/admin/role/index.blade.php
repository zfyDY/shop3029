...
<body>
	...
	<div id="wrapper">
		...
		<!-- 后台 首页 主体 开始 -->
		<div class="main">
			<h1 style="vertical-align: inherit;margin:15px;">角色列表</h1>
			...
			<!-- 搜索框开始 -->
				<div class="form-body" data-example-id="simple-form-inline">
					<form class="form-inline" action="/admin/role" method="get"> 
						<div class="form-group"> 
							<label for="rname">角色名称&nbsp;</label> 
							<input type="text" class="form-control" name="search_rname" value="{{ $params['search_rname'] or '' }}" id="rname" placeholder="角色名称">&nbsp;&nbsp;&nbsp;&nbsp;
						</div> 
			...
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">显示角色详情</h3>
				</div>
				<table class="table table-bordered">
					...
					<tr align="center">
						...
						<td style="line-height:58px;">{{ $v->rname }}</td>
						<td style="line-height:58px;width:300px;">
							<a href="/admin/role/{{ $v->id }}/edit" class="btn btn-info">修改角色权限</a>
